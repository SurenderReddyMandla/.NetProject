...
export class ApiService{
    ...
    putQuestion(question){
        this.http.put('https://localhost:44375/api/questions/${question.id}',question).subscribe(res=>{
            console.log(res);
        })
    }
    getQuizzes(){
    ...
    postQuiz(quiz){
        this.http.post('https://localhost:44375/api/quizzes',quiz).subscribe(res=>{
            console.log(res);
        })
    }
